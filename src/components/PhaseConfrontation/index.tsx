...
const PhaseConfrontation = ({selection1, gols1, flag1, selection2, gols2, flag2, color, originImage}:PhaseConfrotationProps)=>{
    return(
        <div className={`lg:w-1/3 w-4/5 flex justify-center items-center bg-[#E9E9E9] py-3 px-2 lg:m-5 m-2 shadow-md rounded-lg uppercase`}>
