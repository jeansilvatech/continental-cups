...
const HomePage = ()=>{
    ...
    return (
        <div className="w-screen h-dvh flex justify-center items-center flex-wrap animate-enter">
            ...
            hover:after:flex after:justify-center after:items-center hover:after:animate-enter_btn hover:after:content-['Visualizar_a_tabela']
            ">
